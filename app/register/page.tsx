        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex flex-col gap-6 pt-6">
              <button
                type="submit"
                className="w-full bg-white text-black py-4 mt-4 text-xs font-bold uppercase tracking-[0.3em] hover:bg-accent hover:text-black transition-all flex items-center justify-center gap-3"
              >
                <UserPlus className="w-4 h-4" /> Zarejestruj Się
              </button>

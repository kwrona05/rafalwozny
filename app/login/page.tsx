    ...
    <main className="min-h-screen bg-black flex flex-col justify-center px-6 relative overflow-hidden">
      ...
      <div className="max-w-md w-full mx-auto">
        ...
        >
          ...
          <div className="mb-12">
            <h1 className="text-4xl font-serif font-bold text-white mb-2">Panel Admina</h1>
            <p className="text-muted text-sm font-light uppercase tracking-widest">Logowanie do systemu zarządzania</p>
          </div>
